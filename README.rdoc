...
Enhanced ActiveRecord Adapter (link[https://github.com/rsim/oracle-enhanced]) has a few behaviours that I find myself altering
in all my Rails projects. Made sense to throw them all into a gem.
...
that these methods are added to <tt>ActiveRecord::ConnectionAdapters::OracleEnhancedAdapter</tt>.
==
